...
## Who I Am
<!-- Customize: describe your role, stack, and how you work -->
Developer shipping fast. Python (primary), TypeScript (secondary). Speed over ceremony. I want Claude to do the work, not describe it.
...
4. **Correctness** — precision matters, especially for critical business logic.
